...
function groupFruitsByType(fruits: IFruit[]): { [key: string]: string[] } {
...
function getFruitTypesAndWadah(fruits: IFruit[]): {
  jumlahWadah: number;
...
function getTotalStockByType(fruits: IFruit[]): { [key: string]: number } {
...
function getComments(fruits: IFruit[]): string[] {
